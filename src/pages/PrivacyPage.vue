<template>
  <q-page padding class="bg-primary text-white">
    ...
    <p>Stand: 28. Februar 2020</p>
    <h2>Inhaltsübersicht</h2>
    <ul class="index">
      <li><a class="text-white index-link" href="#m14">Einleitung</a></li>
      <li><a class="text-white index-link" href="#m3">Verantwortlicher</a></li>
      <li><a class="text-white index-link" href="#mOverview">Übersicht der Verarbeitungen</a></li>
      <li><a class="text-white index-link" href="#m13">Maßgebliche Rechtsgrundlagen</a></li>
      <li><a class="text-white index-link" href="#m27">Sicherheitsmaßnahmen</a></li>
      <li><a class="index-link text-white" href="#m25">Übermittlung und Offenbarung von personenbezogenen Daten</a></li>
      <li><a class="index-link text-white" href="#m24">Datenverarbeitung in Drittländern</a></li>
      <li><a class="index-link text-white" href="#m134">Einsatz von Cookies</a></li>
      <li><a class="index-link text-white" href="#m182">Kontaktaufnahme</a></li>
      <li><a class="index-link text-white" href="#m225">Bereitstellung des Onlineangebotes und Webhosting</a></li>
      <li><a class="index-link text-white" href="#m136">Präsenzen in sozialen Netzwerken</a></li>
      <li><a class="index-link text-white" href="#m12">Löschung von Daten</a></li>
      <li><a class="index-link text-white" href="#m15">Änderung und Aktualisierung der Datenschutzerklärung</a></li>
      <li><a class="index-link text-white" href="#m10">Rechte der betroffenen Personen</a></li>
      <li><a class="index-link text-white" href="#m42">Begriffsdefinitionen</a></li>
    </ul>
    ...
    <p>Im Rahmen unserer Verarbeitung von personenbezogenen Daten kommt es vor, dass die Daten an andere Stellen,
      ...
      offengelegt werden. Zu den Empfängern dieser Daten können z. B. Zahlungsinstitute im Rahmen von Zahlungsvorgängen,
    ...
    <p><strong>Allgemeine Hinweise zum Widerruf und Widerspruch (Opt-Out): </strong> Abhängig davon, ob die Verarbeitung
      ...
      Browsers erklären, z. B., indem Sie die Nutzung von Cookies deaktivieren (wobei hierdurch auch die
      Funktionsfähigkeit unseres Onlineangebotes eingeschränkt werden kann). Ein Widerspruch gegen den Einsatz von
      Cookies zu Zwecken des Onlinemarketings kann auch mittels einer Vielzahl von Diensten, vor allem im Fall des
      Trackings, über die Webseiten <a class="text-white" href="https://optout.aboutads.info"
      ...
      Daneben können Sie weitere Widerspruchshinweise im Rahmen der Angaben zu den eingesetzten Dienstleistern und
      Cookies erhalten.</p>
    <p><strong>Verarbeitung von Cookie-Daten auf Grundlage einer Einwilligung</strong>: Bevor wir Daten im Rahmen der
      Nutzung von Cookies verarbeiten oder verarbeiten lassen, bitten wir die Nutzer um eine jederzeit widerrufbare
      Einwilligung. Bevor die Einwilligung nicht ausgesprochen wurde, werden allenfalls Cookies eingesetzt, die für den
      Betrieb unseres Onlineangebotes erforderlich sind. Deren Einsatz erfolgt auf der Grundlage unseres Interesses und
      des Interesses der Nutzer an der erwarteten Funktionsfähigkeit unseres Onlineangebotes.</p>
    <ul class="m-elements">
    ...
    <div class="dsg-license-content-blurred"></div>
    ...
    <p>Um unser Onlineangebot sicher und effizient bereitstellen zu können, nehmen wir die Leistungen von einem oder
      ...
      Rechenkapazität, Speicherplatz und Datenbankdienste sowie Sicherheitsleistungen und technische Wartungsleistungen
    ...
    <p>Wir unterhalten Onlinepräsenzen innerhalb sozialer Netzwerke, um mit den dort aktiven Nutzern zu kommunizieren
      oder um dort Informationen über uns anzubieten.</p>
    ...
    <p>Ihnen stehen als Betroffene nach der DSGVO verschiedene Rechte zu, die sich insbesondere aus Art. 15 bis 18 und
      21 DSGVO ergeben:</p>
    <ul>
      ...
      <li><strong>Beschwerde bei Aufsichtsbehörde:</strong> Sie haben ferner nach Maßgabe der gesetzlichen Vorgaben das
        Recht, bei einer Aufsichtsbehörde, insbesondere in dem Mitgliedstaat Ihres gewöhnlichen Aufenthaltsorts, Ihres
        Arbeitsplatzes oder des Orts des mutmaßlichen Verstoßes Beschwerde einzulegen, wenn Sie der Ansicht sind, dass
    ...
    <ul class="glossary">
      ...
      <li><strong>Tracking:</strong> Vom "Tracking“ spricht man, wenn das Verhalten von Nutzern über mehrere
    ...
    <div class="dsg-license-content-blurred"></div>
    <p class="seal"><a class="text-white" href="https://datenschutz-generator.de/?l=de"
    ...
    <h2>Fullstory</h2>
    Wir nutzen FullStory (Fullstory Inc.,120 Ottley Drive NE, Suite 100, Atlanta, GA 30324, USA), um unser Angebot für
    unsere Nutzer zu optimieren. Fullstory zeichnet das Nutzerverhalten auf Teilen unserer Website auf. FullStory setzt
    hierfür Cookies und andere Technologien ein, um Informationen über das Verhalten unserer Nutzer und über ihre
    Endgeräte zu sammeln (z. B. Klicks, Dauer der Sitzung, Browser, Endgerät, Betriebssystem). FullStory speichert diese
    Informationen in einem anonymisierten Nutzerprofil. Nach Ablauf von 3 Wochen werden die Daten gelöscht. Die
    Informationen werden weder von FullStory noch von uns zur Identifizierung einzelner Nutzer verwendet oder mit
